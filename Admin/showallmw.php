...
<br><br>
<?php
$sql = "SELECT id, name, price,color,brand, specification, description, photo FROM mwclothes";
$result = $connection->query($sql);

if ($result->num_rows > 0) 
{
  echo "<table style><tr><th>ID</th><th>Name</th><th>Price</th><th>Color</th><th>Brand</th><th>Specification</th><th>Description</th><th>Photo</th></tr>";
  ...
  while($row = $result->fetch_assoc()) 
  {
     ...
     echo "<tr><td>$id</td><td>$name</td><td>$price</td><td>$color</td><td>$brand</td><td>$specification</td><td>$description</td><td>$photo</td></tr>";
