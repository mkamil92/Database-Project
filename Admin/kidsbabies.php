	...
	if ($result->num_rows > 0) 
	{
	  ...
	  while($row = $result->fetch_assoc()) 
	  {
	    if($id == $row["id"])
	    {
	    	 ...
	    	 echo"<script>alert('Record Already exists Please Re-Enter...');location='kidsbabies.php'</script>";
	    	break;
	    }
	  }
	
	}
		$sql = "INSERT INTO kbclothes (id,name,price, photo, brand, specification,description) VALUES ('$id', '$name', '$price', '$photo' ,'$brand', '$specification', '$description')";
